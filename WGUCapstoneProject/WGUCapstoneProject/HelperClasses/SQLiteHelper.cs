...
namespace WGUCapstoneProject.HelperClasses
{
    ...
    {
        static public string DatabaseDirectory = Directory.GetParent
                (Directory.GetParent
                (Directory.GetParent
                (Environment.CurrentDirectory)
                    .ToString()).ToString()).ToString() + "/PostageDB.db";

        static public SQLiteConnection conn = new SQLiteConnection("Data Source=" + SQLiteHelper.DatabaseDirectory + ";");
